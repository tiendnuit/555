...
class DataUICollectionViewCellPlayList: BaseUICollectionViewCellPlayList {
    ...
    override func setData(_ data: Any?) {
        ...
        if let data = data as? DataUICollectionViewCellPlayListData {
            if data.imageSong.isEmpty == false && data.imageSong != "" && data.imageSong != AppsSettings.Static.BASE_IMAGE_URL + "playlists/tb/" && data.imageSong != AppsSettings.Static.BASE_IMAGE_URL + "videos/tb/" && data.imageSong != AppsSettings.Static.BASE_IMAGE_URL + "artists/tb/" {
